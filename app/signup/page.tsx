    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/50 p-4 font-sans">
      <Card className="w-full max-w-md border-muted">
        <CardHeader className="space-y-1 flex flex-col items-center">
          ...
          <CardDescription>Enter your information to get started with LectureLens</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          ...
          <Button variant="outline" className="w-full gap-2 bg-transparent" onClick={handleSignup}>
            <svg
              className=" h-4 w-4"
              aria-hidden="true"
              focusable="false"
